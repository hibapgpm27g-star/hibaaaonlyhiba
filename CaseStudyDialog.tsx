        ...
        {project && (
          <>
            <div className="relative min-h-72 overflow-hidden sm:min-h-96" data-testid="project-reader-image-frame">
              <img src={project.image} alt={`${project.title} case study`} className="absolute inset-0 h-full w-full object-cover grayscale-[0.85] contrast-[1.05]" data-testid="project-reader-image" />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-10" data-testid="project-reader-hero-copy">
                <div className="flex flex-wrap items-center gap-2" data-testid="project-reader-badges">
                  ...
                  {project.logoUrl ? (
                    <span className="rounded-full border border-white/30 bg-white/90 px-3 py-1" data-testid="project-reader-brand-mark">
                      <img src={project.logoUrl} alt={`${project.brandMark ?? project.title} logo`} className="h-5 w-auto object-contain" />
                    </span>
                  ) : project.brandMark ? (
                    <span className="rounded-full border border-white/30 bg-white/10 px-3 py-1 font-heading text-xs font-semibold tracking-[0.2em] text-white" data-testid="project-reader-brand-mark">{project.brandMark}</span>
                  ) : null}
                </div>
